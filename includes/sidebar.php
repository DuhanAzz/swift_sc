...
<div class="topbar fixed top-0 left-0 right-0 h-14 z-40 flex items-center justify-between px-4 lg:hidden">
    ...
    <div class="flex items-center gap-2.5">
        <div class="w-10 h-10 flex items-center justify-center">
            <img src="../assets/logo.png?v=<?= time() ?>" alt="Swift SC" class="w-full h-full object-contain" onerror="this.onerror=null; this.outerHTML='<div class=\'w-8 h-8 rounded-full bg-algolia-blue flex items-center justify-center\'><svg class=\'w-5 h-5 text-white\' fill=\'none\' stroke=\'currentColor\' viewBox=\'0 0 24 24\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2.5\' d=\'M13 10V3L4 14h7v7l9-11h-7z\'></path></svg></div>';">
        </div>
...
<aside id="sidebar" class="sidebar-nav fixed left-0 top-0 h-full w-[220px] z-50 flex flex-col transform -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-in-out overflow-hidden">
    ...
    <div class="px-5 pt-6 pb-4 flex items-center gap-3 border-b border-slate-800 mb-2">
        <div class="w-16 h-16 flex items-center justify-center flex-shrink-0">
            <img src="../assets/logo.png?v=<?= time() ?>" alt="Swift SC" class="w-full h-full object-contain" onerror="this.onerror=null; this.outerHTML='<div class=\'w-10 h-10 rounded-full bg-algolia-blue flex items-center justify-center flex-shrink-0\'><svg class=\'w-6 h-6 text-white\' fill=\'none\' stroke=\'currentColor\' viewBox=\'0 0 24 24\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2.5\' d=\'M13 10V3L4 14h7v7l9-11h-7z\'></path></svg></div>';">
        </div>
        <div>
    ...
    <nav class="flex-1 px-3 overflow-y-auto pb-4">
        ...
        <?php if ($role == 'ceo'): ?>
            ...
            <a href="../ceo/ceo_panduan_event.php" class="sidebar-link <?= ($current_page == 'ceo_panduan_event.php') ? 'active' : '' ?>">
        ...
        <?php elseif ($role == 'admin'): ?>
            ...
            <a href="../admin/admin_member.php" class="sidebar-link <?= ($current_page == 'admin_member.php') ? 'active' : '' ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            ...
            <a href="../admin/admin_analisis_atlet.php" class="sidebar-link <?= ($current_page == 'admin_analisis_atlet.php') ? 'active' : '' ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                Pantau Analisis Atlet
            </a>
            <a href="../admin/admin_rapor_atlet.php" class="sidebar-link <?= ($current_page == 'admin_rapor_atlet.php') ? 'active' : '' ?>">
        ...
        <?php elseif ($role == 'pelatih' || $role == 'coach'): ?>
            ...
            <a href="../pelatih/pelatih_pusat_panduan.php" class="sidebar-link <?= ($current_page == 'pelatih_pusat_panduan.php') ? 'active' : '' ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                Pusat Panduan
            </a>
            <a href="../pelatih/pelatih_input_lomba.php" class="sidebar-link <?= ($current_page == 'pelatih_input_lomba.php') ? 'active' : '' ?>">
            ...
            <a href="../pelatih/pelatih_analisis_atlet.php" class="sidebar-link <?= ($current_page == 'pelatih_analisis_atlet.php') ? 'active' : '' ?>">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                Analisis Race Pace
            </a>
            <a href="../pelatih/pelatih_input_evaluasi.php" class="sidebar-link <?= ($current_page == 'pelatih_input_evaluasi.php') ? 'active' : '' ?>">
