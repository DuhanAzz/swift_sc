...
<div class="p-4 sm:ml-64">
    <div class="p-4 rounded-lg mt-14">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Manajemen Iuran / SPP</h1>
            ...
            <form action="pembayaran.php" method="GET" class="flex items-center gap-2">
                <select name="bulan" class="bg-white border border-gray-300 text-sm rounded-lg p-2.5">
                    <?php foreach($nama_bulan as $m => $nama) : ?>
                        <option value="<?= $m; ?>" <?= ($filter_bulan == $m) ? 'selected' : ''; ?>><?= $nama; ?></option>
                    <?php endforeach; ?>
                </select>
                <select name="tahun" class="bg-white border border-gray-300 text-sm rounded-lg p-2.5">
        ...
        <div class="bg-white p-2 shadow-sm border border-gray-200 rounded-xl overflow-hidden">
                ...
                <table class="w-full text-sm text-left border-collapse border border-gray-300">
                    <thead class="bg-gray-100 text-gray-700 uppercase text-xs">
                        <tr>
                            ...
                            <th class="border border-gray-300 p-3">Nama Atlet</th>
                            <th class="border border-gray-300 p-3 text-center w-48">Status Bayar</th>
                            <th class="border border-gray-300 p-3 text-center w-48">Nominal (Rp)</th>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="border border-gray-200 p-2 font-bold text-gray-700 uppercase text-xs"><?= $a['nama']; ?></td>
